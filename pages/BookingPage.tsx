...
const BookingPage: React.FC = () => {
  // ==================================================================
  // CORRECCIÓN CLAVE #1: Obtenemos 'service' y 'professional' directamente
  // en lugar de un objeto 'booking'.
  // ==================================================================
  ...
  // OBTENER SERVICIOS Y PROFESIONALES AL CARGAR
  useEffect(() => {
  ...
  // OBTENER HUECOS DISPONIBLES CUANDO CAMBIA LA SELECCIÓN
  useEffect(() => {
    // ==================================================================
    // CORRECCIÓN CLAVE #2: Usamos la variable 'service' directamente.
    // ==================================================================
  ...
  }, [service, professional, selectedDay, currentDate]);
